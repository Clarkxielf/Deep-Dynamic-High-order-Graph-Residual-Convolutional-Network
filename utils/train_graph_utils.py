...
class train_utils(object):
    ...
    def setup(self):
        ...
        if args.lr_scheduler == 'step':
            ...
            self.lr_scheduler = optim.lr_scheduler.CosineAnnealingLR(self.optimizer, args.T_max, eta_min=0, last_epoch=-1, verbose=False)
        else:
    ...
    def train(self):
        ...
        #实例化SummaryWriter
        tb_writer = SummaryWriter(log_dir="runs/{}_{}_{}_{}_{}_{}_{}_0.7-0.3_gldropout0.3_ConvDrop0.3-".format(args.data_name,
                                args.pooltype, args.model_name, args.lr, args.max_epoch, args.lr_scheduler, args.T_max))
        step = 0
        best_acc = 0.0
        batch_count = 0
        batch_loss = 0.0
        ...
        # init_img = torch.zeros((64, 1, 1, 224), device=self.device)
        # tb_writer.add_graph(self.model, init_img)
        ...
        for epoch in range(self.start_epoch, args.max_epoch):
            ...
            for phase in ['train', 'val']:
                    ...
                    if data.x.size(0) == 640:
                        ...
                        with torch.set_grad_enabled(phase == 'train'):
                            ...
                            if args.task == 'Node':
                                ...
                                if args.model_name == 'DDHGRCN':
                                    output, node, edge_index = self.model.graph_learner(inputs)
                                    logits = self.model(node, edge_index, inputs.batch, args.pooltype)
                                else:
                            ...
                            if args.model_name == 'DDHGRCN':
                                labels0 = labels.repeat_interleave(10, dim=0)

                                loss1 = self.criterion(output, labels0)
                ...
                tb_writer.add_scalar(tags[1], epoch_acc, epoch)
                # tb_writer.add_scalar(tags[2], self.lr_scheduler.get_last_lr(), epoch)
